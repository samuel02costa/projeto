                    ...
                    <div class="contact-form">
                        ...
                        <?php
                            ...
                            if(isset($_POST['buttonS'])){
                                ...
                                $cadastro = "INSERT INTO tb_reserva (tb_nome, tb_email, tb_phone, tb_numberguests, tb_date, tb_time, tb_message) VALUES (:nome, :email, :phone, :numberguests, :date, :time, :message)";
                        ...
                        $result->bindParam(':numberguests',$numberguests,PDO::PARAM_STR);
                        ...
                        ?>
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="phone" type="text" id="phone" placeholder="Numero de telefone*" required="">
                              </fieldset>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="time" name="time" id="Horário">
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <button name="buttonS" type="submit" id="form-submit" class="main-button-icon">Make A Reservation</button>
                              </fieldset>
                            </div>
                          </div>
                        </form>
