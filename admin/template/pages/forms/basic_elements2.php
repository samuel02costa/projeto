                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <button name="button" type="submit" class="btn btn-primary mr-2">Submit</button>
                    </form>
                    <?php
                            ...
                            if(isset($_POST['button'])){
                                ...
                                if($password ==  $confirm_password){
                                   ...
                                   echo "as senhas são iguis";
                                } else {
                                    echo "mensagens não coincidem";
                                }
                            }
                            $cadastro = "INSERT INTO tb_contato (name_contato, email_contato, password_contato) VALUES (:name, :email, :password)";
